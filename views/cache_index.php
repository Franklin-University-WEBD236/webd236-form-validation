  ...
  <div class="col-lg-12">
    ...
    <form action="/index" method="post">
      <div class="form-group">
        ...
        <input type="text" min="1" id="required_field" name="form[required_field]" class="form-control" placeholder="Enter something" value="<?php echo(htmlspecialchars($this->value($form['required_field']))); ?>" />
      ...
      <div class="form-group">
        ...
        <input type="text" min="1" id="phone_field" name="form[phone_field]" class="form-control" placeholder="Enter something" value="<?php echo(htmlspecialchars($this->value($form['phone_field']))); ?>" />
